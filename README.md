...
* Ogury: Interstitial.
* Unity: Interstitial.
* AppLovin: Interstitial and Banner
* Startapp: Interstitial and Banner
...
dependencies {
    compile 'gs.oak.adchain:config:0.8.0' // use only for remote config.
    compile 'gs.oak.adchain:adapter-admob:0.8.0' // add adapters you want
}
```
